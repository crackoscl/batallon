...
class Clubes(models.Model):
    nombre = models.CharField(max_length=50)
    region = models.ForeignKey(Region,on_delete=models.CASCADE, related_name='relacion')
    comuna = models.ForeignKey(Comuna,on_delete=models.CASCADE, related_name='relacion')
